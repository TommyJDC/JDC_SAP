    ...
    const AuthPage: React.FC = () => {
        ...
        const checkRedirectResult = async () => {
          try {
            ...
            if (result && result.user) {
              ...
              // Log if no redirect result, which is normal if not just redirected
              console.log("[AuthPage] No redirect result after Google Sign-in, or no user.");
            }
          } catch (error: any) {
      ...
      const handleGoogleSignIn = async () => {
        ...
        try {
          ...
          console.log("[AuthPage] Initiating Google Sign-in Redirect..."); // Log before redirect
          await signInWithRedirect(auth, provider);
          console.log("[AuthPage] Google Sign-in Redirect initiated."); // Log after redirect initiation

          // Note: Redirect happens here, so code after this might not execute immediately.
          // Result is handled in useEffect.

        } catch (googleError: any) {
          console.error('[AuthPage] Google authentication error:', googleError);
          setIsLoading(false);
